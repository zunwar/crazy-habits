...
class HabitAdapter(
    private val onItemClicked: (HabitEntity) -> Unit,
    private val onItemLongClicked: (HabitEntity) -> Unit
    ...
    companion object {
        val DIFF_CALLBACK: DiffUtil.ItemCallback<HabitEntity> =
            object : DiffUtil.ItemCallback<HabitEntity>() {
                override fun areItemsTheSame(oldItem: HabitEntity, newItem: HabitEntity): Boolean {
                    return oldItem.id == newItem.id
                }

                override fun areContentsTheSame(
                    oldItem: HabitEntity, newItem: HabitEntity
                ): Boolean {
